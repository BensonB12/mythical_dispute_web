...
- [x] Nov 13
  - [x] There are now images in the api, and a docker image that has all the starting images
  - There are now tests
    - [x] Client using vitest
    - [x] API using xunit
  - The Pipeline now depends on
    - [x] No build errors
    - [x] Tests
    - [x] Linting
  - The client now has
